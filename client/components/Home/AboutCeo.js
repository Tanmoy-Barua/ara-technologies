            ...
            <div className="row">
                <div className="col-12 col-md-6">
                    <div className="image-ceo">
                        <Image src={ImageCeo} alt="ceoImage" className="img-fluid"/>
                    </div>
                ...
                <div className="col-12 col-md-6 text-center text-lg-start">
                    ...
                    <div className="about-icon-content">
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-md-11 ps-0 ps-lg-5">
                    ...
                    <div className="row">
                        <div className="col-md-4 text-center">
                            <div className="counter-rating">
                                {counterOn && <h3><CountUp start={0} end={8784} separator="," /></h3>}
                                <h4>8,784+ Ratings</h4>
                            </div>
                        </div>
                        <div className="col-md-4 text-center">
                        <div className="counter-client">
                            {counterOn && <h3><CountUp start={0} end={3200} separator="," /></h3>}
                            <h4>Happy Clients</h4>
                            </div>
                        </div>
                        <div className="col-md-4 text-center">
                        <div className="counter-team">
                            {counterOn && <h3><CountUp start={0} end={50}/></h3>}
                            <h4>Expert Team</h4>
                            </div>
                        </div>
                    </div>
